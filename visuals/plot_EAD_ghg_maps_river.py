# -*- coding: utf-8 -*-
"""
plot_EAD_ghg_maps_river.py
Based on EAD&ghg_with_protection_scenarios_river_2024_12_08.py
Updated to use 2026 pipeline output.

6-panel map: EAD (left) and GHG (right) for Historical / RCP4.5-2080 / RCP8.5-2080
flood_type = river, threat = EAD_current_dike
"""
...
def make_ead_ghg_map_river():
    ...
    out = os.path.join(VISUALS_DIR, f"EAD&ghg_current_dike_scenarios_river_rev_{current_date}.png")
