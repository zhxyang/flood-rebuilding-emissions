# -*- coding: utf-8 -*-
"""
plot_EAD_ghg_maps_coastal.py
Based on EAD&ghg_with_protection_scenarios_coastal_2024_12_08.py
Updated to use 2026 pipeline output.

6-panel map: EAD (left) and GHG (right) for Historical / RCP4.5-2080 / RCP8.5-2080
flood_type = coastal, threat = EAD_current_dike
"""
...
def make_ead_ghg_map_coastal():
    ...
    out = os.path.join(VISUALS_DIR, f"EAD&ghg_current_dike_scenarios_coastal_rev_{current_date}.png")
