...
def make_exposure_map():
    ...
    # combined = river + coastal
    shp_combined = shp_river.copy()
    shp_combined['tonne_million'] = (shp_river['tonne_million'].fillna(0) +
                                     shp_coastal['tonne_million'].fillna(0))
    ...
    _panel(fig.add_subplot(spec[2]), shp_combined, 'c   River & Coastal')
